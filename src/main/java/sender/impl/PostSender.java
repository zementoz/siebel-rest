    ...
    public SiebelPropertySet send(SiebelPropertySet input) throws Exception {
        ...
        if (input.getProperty("URI") != null && !input.getProperty("URI").equals("")) {
            ...
            if (input.getProperty("DynamicURI") != null && !input.getProperty("DynamicURI").equals("")) {
                request = new HttpPost(input.getProperty("URI") + input.getProperty("DynamicURI"));
            } else {
                request = new HttpPost(input.getProperty("URI"));
            }
            ...
            if (input.getValue() != null && !input.getValue().equals("")) {
                request.setEntity(new StringEntity(input.getValue(), Charset.forName("UTF-8")));
            }
